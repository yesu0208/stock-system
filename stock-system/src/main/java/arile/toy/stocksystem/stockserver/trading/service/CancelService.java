    ...
    public void registerCancel(CancelRequestEvent request) {
        ...
        switch (result.previousStatus()) {
            ...
            default -> {
                ...
                long refundAmount = (long) orderEntity.getOrderPrice() * orderEntity.getRemainingQuantity();
                boolean refunded = accountBalanceCommand.refundReservedCash(orderEntity.getUsername(), refundAmount);
