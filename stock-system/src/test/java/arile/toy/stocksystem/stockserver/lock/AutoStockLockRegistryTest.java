...
class AutoStockLockRegistryTest {

    private final AutoStockLockRegistry lockRegistry = new AutoStockLockRegistry();

    @Test
    @DisplayName("주식 코드로 Lock을 요청하면 ReentrantLock을 반환한다")
