...
@Slf4j
public class RedisOtocoCancelRequestEventConsumer {
    ...
    public void consume() {
        ...
        for (MapRecord<String, Object, Object> record : records) {
            try {
                ...
                if (!"OTOCO_CANCEL_CREATED".equals(type)) {
    ...
    private void moveToDLQ(MapRecord<String, Object, Object> record) {
        ...
        streamRedisTemplate.opsForStream().add(
                StreamRecords.mapBacked(dlqData)
                        .withStreamKey("otoco-cancel-dlq")
        );
    }

    private String processedKey(String recordId) {
        return "processed:otocoCancel:" + recordId;
    }
